...
<section>
    ...
    <div class="row d-flex justify-content-around">
      ...
      <main class="col-7 py-md-5 pl-md-4 " >
          ...
          <hr>
          <div class="card-deck">
            <a class="card bg-primary pt-3 pb-3" href="myPagePwCheck">
            <div>
            ...
            <div >
              <div class="card-body text-center">
                ...
                <p class="card-text mt-5" style="font-size: 30px;">판매자 등록</p>
              </div>
            </div>
          </a>
            <a class="card bg-primary pt-3 pb-3" href="">
            <div>
              <div class="card-body text-center">
                ...
                <p class="card-text mt-5" style="font-size: 30px;">장터 운영자 등록</p>
              </div>
            </div>
            </a>
          </div>
