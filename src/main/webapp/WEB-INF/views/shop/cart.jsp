...
<form name="orderform" id="orderform" method="post" class="orderform" action="/shop/order" onsubmit="return false;">
        ...
        <div class="basketdiv" id="basket">
            ...
            <div class="row data">
                <div class="subdiv">
                    ...
                    <div class="img"><img src="/display/product/${product.productNo}" width="80" height="80"></div>
                    <div class="pname">
        ...
        <div class="bigtext right-align sumcount" id="sum_p_num">상품갯수: ${orderQN}개</div>
        <div class="bigtext right-align box blue summoney" id="sum_p_price">합계금액: <fmt:parseNumber value="${(product.productPrice - (product.productPrice*product.productSale * 0.01)) * orderQN}" integerOnly="true" />원</div>
