...
public interface MarketMapper {
	...
	/* ================= 장터 참여 신청 목록 보기 ================= */
	public List<ProductDTO> selectReceive(@Param("marketNo")int marketNo, @Param("criteria")Criteria criteria); // 상품 조회 (상품 상태 0 & 장터 번호)
	...
	/* ================= 장터 참여 승인 목록 보기 ================= */
	public List<ProductDTO> selectAcceptList(@Param("marketNo")int marketNo, @Param("criteria")Criteria criteria); // 상품 조회 (상품 상태 1 & 장터 번호)
	...
	/* ====================== 장터 공지 목록 보기 ====================== */
	public List<NoticeDTO> selectNoticeList(@Param("marketNo")int marketNo, @Param("criteria")Criteria criteria); // 공지 게시판 조회
	...
	/* ================== 장터 판매 상품 목록 보기 ================== */
	public List<ProductDTO> selectProductList(@Param("marketNo")int marketNo, @Param("criteria")Criteria criteria); // 상품 조회 (상품 상태 3 & 장터 번호)
	...
	/* ====================== 장터 후기 목록 보기 ====================== */
	public List<ReviewDTO> selectReviewList(@Param("marketNo")int marketNo, @Param("criteria")Criteria criteria); // 한 줄 후기 조회 (장터 번호)
